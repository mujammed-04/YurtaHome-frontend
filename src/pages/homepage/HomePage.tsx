    ...
    <section className="homepage">
      <div className="container">
        <div className="homepage__wrapper">
          ...
          <Carousel
            items={interiors}
            title="Вы ищете такие фотографии?"
            subtitle="Рекомендуем интерьерные оформления, которые могут вам понравиться"
            interior
          />
          <Carousel
            items={rooms}
            title="Мы собрали для вас несколько стильных новых домов"
            house
          />
